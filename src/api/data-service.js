...
const teachers = [
 ...
 function sendDatas(params) {
  teachers.forEach(function (teacher) {
    axios.post(`http://localhost:8080/teachers/new`,{ teacherId: teacher.sno, name: teacher.name, designation: teacher.designation, joiningDate: teacher.joinDate, teachTo: teacher.teachTo }).then((d)=>{
      console.log(d.data);
    })
